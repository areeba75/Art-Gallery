...
const AddToCard = () => {
  ...
  const toggleSidebar = (content = '') => {
    setSidebarContent(content); // Set the content to display in the sidebar
    setIsSidebarOpen(!isSidebarOpen); // Toggle sidebar visibility
  };
  return (
    <>
      <section>
        <div className='flex flex-col pt-40 px-20 gap-4'>
          {/* Text Area */}
          <p>Homepage/ [AB#007] Abstract Painting 07</p>
          <h3 className='text-[#F6C934]'>[AB#007] Abstract Painting 07</h3>
          <p className='text-[#F6C934] text-sm underline'>Miguel Camarena Art Gallery</p>
          <div>
          ...
          <div>
            <Accordion open={open === 1} icon={<Icon id={1} open={open} />} className='w-fit'>
              <AccordionHeader onClick={() => handleOpen(1)} className='text-2xl  pt-10'>
                Description
              </AccordionHeader>
          ...
          {/* Underline Components to trigger Sidebar */}
          <div>
          {/* Trigger Sidebar */}
          ...
          <div className=''>
            ...
            <p className='text-[#F6C934] text-xs'>Usually ready in 2-4 days</p>
          </div>
          <div>
            <Underline
  ...
  return (
    <div className='relative' onClick={onClick}>
      <div className='w-fit h-[84px] cursor-pointer group'>
        <h2 className='text-base'>{h2Text}</h2>
