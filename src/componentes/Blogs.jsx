    ...
    <>
      <section className="overflow-x-hidden">
        <div className="m-auto mb-10">
          <div className="px-7">
            <div>
            <p className=" text-[#F6C934] m-[2.4rem]">
          <Link className="" to="/">
            HomePage
          </Link>
          &nbsp;/&nbsp;News
          ...
          {/* 1 */}
          <div className="flex flex-wrap xl:w-[1184px] md:justify-evenly gap-4 sm:px-7 m-auto mt-20 pt-8">
          ...
          {/* 2 */}
          <div className="flex flex-wrap xl:w-[1184px] md:justify-evenly md:gap-4 sm:px-7 m-auto mt-20 pt-8">
            {selectedItems.slice(6, 12).map((item, index) => (
              <BlogCard
                key={index.id}
                image={item.image}
                heading={item.heading}
          ...
          <div className="flex gap-8 justify-center items-center mt-12">
            ...
            {currentPage < totalPages && (
              <button
                onClick={() => handelCurrentPage(currentPage + 1)}
                className="px-2 py[20px] border border-yellow-400 hover:border-yellow-700  hover:text-yellow-700 md:text-3xl sm:text-[20px]"
              >
                &#11208;
              </button>
            )}
...
const BlogCard = ({ image, heading, subHeading, author }) => {
  return (
    <>
      <div className="md:w-[320px] px-5 text-white group cursor-pointer m-auto">
        <div
        ...
        <div>
          <h2 className="font-serif font-semibold sm:text-lg group-hover:underline">
            {heading}
          </h2>
          <p className="text-3xl sm:text-xl my-4">{subHeading}</p>
          <p className="text-xl sm:text-base">Posted by {author}</p>
        </div>
      </div>
    </>
  );
      ...
      <div className=" text-white px-5 md:flex md:w-4/5 m-auto">
        ...
        <div className="p-1 sm:pl-12 sm:pb-14 flex flex-col justify-end border w-full md:w-1/2">
          <div className="sm:w-2/3">
            <h2 className="font-serif sm:font-semibold  sm:text-lg group-hover:underline">
              {heading2}
            </h2>
            <p className="text-2xl sm:text-sm my-4">{subHeading2}</p>
            <div className="w-fit">
              <p className="text-2xl sm:text-base text-[#F6C934]">Read More</p>
