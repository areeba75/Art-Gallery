    ...
    <>
      <div>
        ...
        <div className="flex flex-col justify-around">
         ...
         <h2>Exclusive Donkey Collection</h2>
          <p className="tracking-wider mb-[8px]">
          ...
          <button className="custom-button" onClick={() => window.location.href = '#'}>View Full Collection</button>
         </div>
          {/* Test component */}
