...
<div className=' mb-[40px]'>
        ...
        <h1 className='font-bold my-[32px] md:font-black  lg:text-4xl text-2xl text-center'>
          Welcome To The World Of Art
        </h1>
        <div
          className=" mb-4 leading-7 lg:w-2/5 w-full text-center"
        
        >
          
         <p> <strong className="italic text-white leading-7">
          ...
          <p>
            ...
            email at&nbsp;
            <a
              className="border-b text-[18px] text-white"
