...
import wholsale from '../../assets/wholesale.webp'
        ...
        <div className='lg:space-y-32'>
          ...
          <div className='flex flex-col py-12 px-5'>
                <div className='text-white md:flex items-center m-auto py-5'>
                    ...
                    <p className='md:w-1/2 text-left'>We love challenges, especially when handling mass orders for wholesale art supplies for businesses. Be it a time-sensitive project or an expanded installation, we've got you covered! Even with the bulk order, we ensure to meet the deadlines, and you get your shipment on your doorstep right on time!</p>
                </div>
              ...
              <div className=' p-6'>
                ...
                <div className='text-white md:flex items-center m-auto py-5'>
                    ...
                    <p className='md:w-1/2 text-left'>We are rooted in Arizona to serve our local clients, but boundaries do not bind our wings. We have clients all over the world. You can communicate with us online, over the phone, or in person at our gallery location about your art needs.</p>
                </div>
            </div>
          </div>
          </div>
