...
const RentingArt = () => {
  ...
  return (
    <>
      <h2 className="text-center pt-10 font-extrabold text-[24px] lg:text-[38px]">
      ...
      <section>
        <div className="flex flex-col lg:flex-row w-full  pt-[128px] pb-[50px] px-5">
          ...
          <div className="flex items-center lg:pl-30 sm:px-10 w-full lg:w-1/2">
           <div>
           <h2>Renting Artwork For Real Estate And Home Staging</h2>
            <p className="mt-4 text-justify text-[20px] leading-[2rem]">
      ...
      <section>
        <div>
          <div>
            <div>
              <div className="mx-auto px-5 sm:px-20 lg:w-[800px]">
                <h2 className="text-[39px]">What Is Art Staging?</h2>
      ...
      <section>
        <div className="flex justify-between flex-col lg:flex-row">
          <div className="lg:w-1/2">
            {/* <img className="w-[951.5px] h-[866.25px]" src={panda}></img> */}
            <img className="w-full" src={panda}></img>

          </div>
          <div className="hidden lg:flex items-center pl-20 lg:w-1/2">

          <div>
            <h2>Exhibit Rental Art To Sell Your Property In Arizona</h2>
            <p>
              First impressions are everything! The longer a home is on the
              market, the less money the seller is expected to get. So what's
              the solution?
              <br />
            </p>
            <p>
            ...
            <br />
            <button className="custom-underline font-bold text-[22px] tracking-wider">
      ...
      >
        <div className="lg:w-[800px] py-10 m-auto px-10">
          <h3 className="lg:text-[24px] text-base text-[20px] lg:extrabold pt-10">
          ...
          >
            <AccordionHeader
              ...
              className="lg:text-[22px] text-base"
            >
