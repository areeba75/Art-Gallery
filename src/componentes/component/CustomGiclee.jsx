        ...
        <div className='flex items-center justify-between flex-row-reverse'>
           ...
           <div className='flex justify-center m-auto'>
               ...
               <h1 className='text-[#F6C936] text-3xl font-bold'>Custom Giclee Prints? Sure!</h1>
                <p className='text-lg'>Your choice and preference can differ from ours, and we respect that. Customization is our specialty, and our Unique Selling Point is to provide satisfied customer service to our clients. Be it printing on a particular canvas size or making some amendments to the design, we do it all!</p>
                <div className='w-auto'>
                   <Link to={'/contact'}>
                        <button className='text-[#f6c936]'> Shop all
