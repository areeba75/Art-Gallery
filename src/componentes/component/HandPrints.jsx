...
import hand_prints from '../../assets/hand_prints.webp'
    ...
    <section>
        <div className='flex items-center '>
            <div className='w-full'>
                <img src={hand_prints} alt="" className='w-[100%]'/>
            </div>
