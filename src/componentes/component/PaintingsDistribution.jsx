  ...
  return (
    ...
    <div>
        <div className='text-white text-center lg:w-1/2 xl:1/3 lg:m-auto space-y-6 py-12 px-6 lg:px-0'>
            ...
            <p className=''>We distribute wholesale prints to hotels, galleries, designers, art consultants, and more in Cave Creek, Arizona and
            ...
            <div className='w-auto'>
                   <Link to={'/collection'}>
                        <button className='text-[#f6c936]'> Join Our Wholesale Art Distribution Network Today  
