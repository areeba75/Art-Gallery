    ...
    <div className='flex items-center justify-between flex-row-reverse'>
       ...
       <div className='flex justify-center m-auto'>
           ...
           <h1 className='text-[#F6C936] text-3xl font-bold'>Wholesale Artwork Distributor Of 30 Years</h1>
            <p className='text-lg'>Your space is precious; therefore, how you decorate and decorate that space should be a smooth and enjoyable process. Therefore, work with one of the best wholesale artwork distributors.
